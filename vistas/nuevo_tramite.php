                ...
                <div class="card">
                    ...
                    <div class="card-body table-border-style">
                        <form id="formTramiteCompleto">
                            ...
                            <div class="card mb-2 ">
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <div id="detalle_tupa" class="my-2" style="display:none;">
                                        <div class="row g-2">
                                            <div class="col-md-9">
                                                <div class="p-3 border rounded  h-100" style="background-color: #0a2152;">
                                            ...
                                            <div class="col-md-3">
                                                <div class="p-3 border rounded  h-100 d-flex flex-column justify-content-center" style="background-color: #0a2152;">
                                                    <small class="text-uppercase fw-bold text-white d-block mb-2" style="font-size: 0.7rem;">
                                                        Derecho de Pago
                                                    </small>
                            ...
                            <div class="row g-2 mb-2">
                                <div class="col-md-6">
                                    <div class="card h-100 " style="min-height: 220px;">
                                        <div class="card-header py-2 px-3 bg-light">
